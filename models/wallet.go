...
func (m *WalletModel) Create(ctx context.Context, userID int32, name, walletType string) (*Wallet, error) {
...
func (m *WalletModel) Update(ctx context.Context, id, userID int32, name, walletType string) (*Wallet, error) {
